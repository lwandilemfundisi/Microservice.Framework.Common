...
namespace Microservice.Framework.Common
{
    ...
    {
        public static TValueObject ToValueObject<TValueObject>(this string value) where TValueObject : XmlValueObject
        {
            if(value.IsNotNullOrEmpty())
            {
                return XmlValueObject.Repository.Find<TValueObject>(value);
            }
